...
const HomeDash = () => {
  ...
  >
    ...
    <FaUsers className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 ml-2 text-white" />
          ...
          <div className='flex items-center justify-center lg:w-[80%] md:w-[80%] sm:w-[90%] w-[80%]'>
            <img src={lapView} alt="Root-Ed" className='lg:w-[100%] md:w-[100%] sm:w-[120%] w-[120%] -mt-10'/>
          </div>
