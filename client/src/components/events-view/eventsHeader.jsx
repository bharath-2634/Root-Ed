...
import world_img from "../../assets/events_header_bg.png";
...
const EventsHeader = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center gap-3 font-poppins h-96 bg-center bg-cover" style={{ backgroundImage: `url(${world_img})`}}>
