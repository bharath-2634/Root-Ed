      ...
      <section className='w-full px-4 md:px-8 lg:px-16 py-12 md:py-16 lg:py-20 font-poppins bg-white'>
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='mb-8 md:mb-12 text-center'>
            <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold text-primary_nav leading-tight'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            ...
            <div className='bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col'>
              ...
              <h3 className='text-xl md:text-2xl font-semibold mb-4 text-[#131D2D]'>
                Expert Instructors
              </h3>
            ...
            <div className='bg-primary_nav text-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col md:col-span-2 lg:col-span-1 lg:row-span-2'>
              ...
              <button className='bg-primary hover:bg-[#00a859] text-white font-semibold px-6 py-3 rounded-full flex items-center gap-2 transition-all duration-300 hover:shadow-lg group w-fit mt-auto' onClick={()=>navigate("/auth/login")}>
                Start Free Trial
            ...
            <div className='md:col-span-2 lg:col-span-2 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col'>
              <div className='w-14 h-14 rounded-full flex items-center justify-center mb-6 bg-white shadow-sm'>
