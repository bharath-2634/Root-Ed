    ...
    <section className='w-full px-4 md:px-8 lg:px-16 py-12 lg:py-20 font-poppins bg-white'>
      <div className='p-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <div className='bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col xl:py-10 xl:px-8'>
          ...
          <div className='md:col-span-2 lg:col-span-2 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col xl:py-10 xl:px-8'>
            <div className='w-14 h-14 rounded-full flex items-center justify-center mb-6 bg-white shadow-sm'>
